...
from .policy import RotationPolicy, RotationStatus, RotationStrategy as PolicyStrategy, RotationState
from .exceptions import RotationFailedError, RotationNotAllowedError
from .strategy import RotationStrategyType, RotationStrategyContext
...
class RotationExecutor:
    ...
    async def execute_rotation(
        ...
        try:
            ...
            strategy_type = self._map_policy_to_strategy(
                rotation_policy.strategy
            )
