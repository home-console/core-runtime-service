...
def register_admin_core_http_endpoints(http_registry: Any) -> None:
    ...
    extra_endpoints = [
        HttpEndpoint(
            method="GET",
            path="/api/v1/admin/inspector/dashboard-cards",
            service="admin.v1.inspector.dashboard_cards",
            description="Inspector: aggregate server-driven dashboard cards from plugin manifests",
            auth_config=_admin_read,
            tags=["Inspector"],
            response_model=ApiResponse[DashboardCardsListDto],
        ),
        HttpEndpoint(
            method="GET",
        ...
        HttpEndpoint(
            method="GET",
            path="/api/v1/admin/inspector/plugins/{name}/ui",
            service="admin.v1.inspector.plugins.ui",
            description="Inspector: server-driven UI contributions from plugin.json",
            auth_config=_admin_read,
            tags=["Inspector"],
            response_model=ApiResponse[PluginUiContributionsDto],
        ),
        HttpEndpoint(
            method="GET",
            path="/api/v1/admin/inspector/plugins/{name}/config",
            service="admin.v1.inspector.plugins.config.get",
            description="Inspector: server-driven plugin ui_config storage",
            auth_config=_admin_read,
            tags=["Inspector"],
            response_model=ApiResponse[PluginConfigDto],
        ),
        HttpEndpoint(
            method="PUT",
            path="/api/v1/admin/inspector/plugins/{name}/config",
            service="admin.v1.inspector.plugins.config.set",
            description="Inspector: update plugin ui_config storage",
        ...
        HttpEndpoint(
            method="POST",
            path="/api/v1/admin/inspector/plugins/{name}/invoke",
            service="admin.v1.inspector.plugins.invoke",
            description="Inspector: invoke allowlisted plugin service (UI metrics)",
            auth_config=_admin_write,
            tags=["Inspector"],
            response_model=ApiResponse[PluginServiceInvokeResult],
        ),
        HttpEndpoint(
            method="GET",
