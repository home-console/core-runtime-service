"""
Capability Registry — metadata registry for capabilities (Step 2, D2).
...
from core.capability.security import check_capability_namespace_permission, trust_level_to_privilege
...
class CapabilityRegistry:
    ...
    - set_provider_health(plugin_name, capability_id, healthy, ...)
    ...
    async def register_provider(
        ...
        check_capability_namespace_permission(capability_id, plugin_name, plugin_privilege)
    ...
    def trust_level_to_privilege(self, trust_level: object = None) -> str:
        ...
        Delegates to security module's trust_level_to_privilege function.
        
        Converts TrustLevel enum to privilege level for capability registration.
