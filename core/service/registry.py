    ...
    async def call(self, service_name: str, *args, **kwargs) -> Any:
        ...
        if self._default_timeout is not None:
            return await asyncio.wait_for(
                self._invoke_with_middleware(service_name, func, middleware, *args, **kwargs),
                timeout=self._default_timeout
            )
        else:
            return await self._invoke_with_middleware(service_name, func, middleware, *args, **kwargs)
