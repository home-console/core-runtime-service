...
**Timestamp**: 2026-04-08T13:31:12.504758
...
**Mitigation**:  
mTLS (flow) + request signing + audit logging

**Residual Risk**:  
Not yet addressed. flow required.

**Notes**:  
Out of scope for flow. Hardened vault only protects secrets, not commands.
...
**Mitigation**:  
Code signing (flow) + artifact scanning + runtime policy checks
